...
## 포트폴리오를 준비하며 느낀 점
+ 2D 게임을 개발해보고 싶기도 했고, C#도 언젠가 공부해놓으면 좋을 것 같아서 이번에 처음으로 C#과 유니티를 공부했는데
  ...
  인프런 강의와 구글링을 통해 공부했는데 금방 끝낼 수 있을 줄 알았으나 위의 이유로 생각보다 오래 걸렸다. (약 2달 정도 걸린 것 같다.)

  언리얼은 이미 컴포넌트, 액터 등 만들어져 있는 틀이 있는데,
  유니티는 아예 빈 깡통에서 시작해서 스크립트에 기능들을 만들고, 게임 오브젝트에 붙여야 해서 
  처음에는 언리얼보다 어렵겠다라고 생각이 들었다. 그런데 막상 해보고 익숙해지니 오히려 더 쉽고, 자유도가 있는 느낌이 들었다.
